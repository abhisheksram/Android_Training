    ...
    override fun onRequestPermissionsResult(
        ...
        if (requestCode == 100) {
            if (grantResults.isNotEmpty() && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                if (requestCameraAgain) Toast.makeText(applicationContext,"Camera Permission Denied",
                    Toast.LENGTH_LONG).show()
                else {
                    Toast.makeText(applicationContext,
                        "Camera Permission Denied, Go to settings and enable Permission", Toast.LENGTH_LONG).show()

                    val builder = AlertDialog.Builder(this@MediasActivity)
            ...
            if (grantResults.isNotEmpty() && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                if (requestStorageAgain) Toast.makeText(applicationContext,"Storage Permission Denied",
                    Toast.LENGTH_LONG).show()
                else {
                    Toast.makeText(this@MediasActivity,
