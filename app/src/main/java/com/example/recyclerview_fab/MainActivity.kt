...
class MainActivity : AppCompatActivity() {
    ...
    private fun addInfo() {
        ...
        datePick.setOnClickListener {
            ...
            val dateListener = DatePickerDialog(this, { _, year, month, day ->

                val month1 = month + 1
                val myMonth = if (month1 < 10) "0$month1" else {
                    "$month1"
                }
                val myDay = if (day < 10) "0$day" else {
                    "$day"
                }
                dateShow = "$myDay-$myMonth-$year"
    ...
    private fun onItemClicked(myData: MyData?, position: Int) {
        with(Dialog(this@MainActivity)) {
            ...
            datePick.setOnClickListener {
                ...
                val dateListener = DatePickerDialog(this@MainActivity, { _, year, month, day ->
                    ...
                    val dateShow = "$myDay-$myMonth-$year"
